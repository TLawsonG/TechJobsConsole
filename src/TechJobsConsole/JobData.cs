...
namespace TechJobsConsole
{
    class JobData
    {
        ...
        {   
            ...
            {
                foreach (KeyValuePair<string, string> jobDetails in jobs)
                {
                    string insensitive = jobDetails.Value;
                    insensitive = insensitive.ToUpper();
                    if (insensitive == value.ToUpper())
                    {
                        if (!SomeJobs.Contains(jobs))
                        {
                            SomeJobs.Add(jobs);
                        } 
                    }
